...
*	You may not download data items classified as as ‘consortium access’ or ‘restricted access’ from CLIMB-COVID. (See [classification of data items](data-classification)). Analysis of consortium or restricted access data must be conducted on CLIMB-COVID.<sup>4</sup> For clarity:
